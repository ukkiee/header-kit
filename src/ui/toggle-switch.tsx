...
export function ToggleSwitch(props: ToggleSwitchProps) {
  return (
    <Switch.Root
      ...
      className="flex h-5 w-9 shrink-0 cursor-pointer rounded-full bg-zinc-300 p-0.5 transition-colors disabled:cursor-default data-[checked]:bg-primary dark:bg-zinc-700"
      {...props}
    >
