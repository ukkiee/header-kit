...
const en = {
  ...
  tabModifications: 'Modifications',
  tabFilters: 'Filters',
  ...
  ariaHeaderTarget: 'Header target',
  ariaHeaderValue: 'Header value',
  ariaRemoveModification: 'Remove modification',
  ariaToggleRowOptions: 'Toggle modification options',
  ...
  ariaEnableFilter: 'Enable filter',
  ariaRemoveFilter: 'Remove filter',
  ariaFilterTab: 'Tab',
  ariaFilterTabGroup: 'Tab group',
  ariaFilterWindow: 'Window',
  ariaTabDomain: 'Tab domain',
  ariaExpiresAt: 'Expires at',
  ariaInitiatorDomain: 'Initiator domain',
  ariaUrlPattern: 'URL pattern',
  ariaExcludePattern: 'Exclude pattern',
  ariaBadgeColor: 'Badge color',
  ariaProfileName: 'Profile name',
  ariaBadgeLabel: 'Badge label',
  ariaProfileMenu: 'Profile menu',
  ariaAddModification: 'Add modification',
...
export const MESSAGES: Record<Locale, Record<MessageKey, string>> = {
  ...
  ko: {
    ...
    ariaHeaderTarget: '헤더 대상',
    ariaHeaderValue: '헤더 값',
    ariaRemoveModification: '수정 제거',
    ariaToggleRowOptions: '수정 옵션 펼치기/접기',
    ...
    ariaEnableFilter: '필터 활성화',
    ariaRemoveFilter: '필터 제거',
    ariaFilterTab: '탭',
    ariaFilterTabGroup: '탭 그룹',
    ariaFilterWindow: '창',
    ariaTabDomain: '탭 도메인',
    ariaExpiresAt: '만료 시각',
    ariaInitiatorDomain: 'Initiator 도메인',
    ariaUrlPattern: 'URL 패턴',
    ariaExcludePattern: '제외 패턴',
    ariaBadgeColor: '배지 색',
    ariaProfileName: '프로필 이름',
    ariaBadgeLabel: '배지 라벨',
    ariaProfileMenu: '프로필 메뉴',
    ariaAddModification: '수정 추가',
    ariaAddFilter: '필터 추가',
